        ...
        <div className='w-full lg:w-1/2 text-colorBold text-center lg:text-left'>
            ...
            <div className='flex flex-col gap-5 border-b border-colorNormal pb-6'>
                ...
                <div className='flex gap-4'>
                    <span className='flex items-center text-sm gap-3'><Image src={fastDelivery} alt='fast Delivery icon' width={30} height={30}/> Free Delivery </span>
                    <span className='flex items-center text-sm gap-3'><Image src={voucher} alt='Voucher icon'/> Available Voucher </span>
                    <span className='flex items-center text-sm gap-3'><Image src={mypackage} alt='package icon'/> In Stock </span>
                </div>
            </div>
            <div className='mt-5 flex flex-col gap-4'>
                <h3 className='font-semibold'>Description</h3>
                <p className='text-colorNormal text-sm'>Wireless Microphone with the new style, shockproof, clear voice reception that suitable for recording, online meeting, vlogging, and calling. Free casing with high-quality zipper.</p>
            </div>
