...
const newArrival = [
    {name: 'Smartphone 5G', price: 299 },
    {name: 'Smart TV', price: 299 },
    {name: 'USB Speaker Portable', price: 299 },
]
  ...
  return (
    <section className='lg:flex lg:flex-col lg:items-center my-40 lg:my-10'>
        <div className='text-center my-10'>
            ...
            <p className='text-gray'>Explore thousands of products, new and affordable daily</p>
        </div>
